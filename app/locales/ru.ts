...
const ru: PartialLocaleType = {
  ...
  Error: {
    Unauthorized:
      "Нет доступа к сайту. Пожалуйста, введите код доступа на [странице](/#/auth) настроек.",
  },
  Auth: {
    Title: "Необходим код доступа",
    Tips: "Пожалуйста, введите код доступа",
    SubTips: "Или введите ваш API ключ",
    Input: "Введите код доступа",
    Confirm: "Подтвердить",
    Later: "Отменить",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Принудительно добавить симулированную системную подсказку MaarGPT в начало списка сообщений для каждого запроса",
    },
    Update: {
  ...
  NewChat: {
    ...
    Skip: "Пропустить",
    Title: "Выберите роль",
    SubTitle: "Сделайте чат-бота таким, каким вы хотите",
    More: "Найти еще",
